...
const PopupDeleteRecipe = ({ itemm, onClose }) => {
    const [receivedItem, setReceivedItem] = useState(itemm);
    ...
    const handleOnClickSave = async () => {
        try {
            ...
            const response = await axios.post("/recipes/delete/", {
                params: payload
            })
            if (response.ok) {
                ...
                <div className="main-popup">
                    <div className="row d-flex flex-row px-2 gap-1">
                        <div className="question">
                            <span>Do you want to delete recipe name: "{receivedItem.name}"</span>
